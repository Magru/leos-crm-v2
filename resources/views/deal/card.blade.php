<div class="card">
    <div class="card-body">
        <div class="sub-title">אמצעי תשלום</div>
        <div class="form-group row">
            <div class="col-12 row">
                <div class="preload col-6 d-flex justify-content-center pt-3" style="direction: ltr!important;">
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">JOHN DOE
                        </text>
                ...
                <div class="form-container col-6">
                    <div class="field-container row">
                        <div class="col-6">
                            <input id="card-name" maxlength="20" name="card-name" placeholder="שם" type="text">
                        </div>
                        <div class="col-6">
                            <input id="card-id" maxlength="20" name="card-id" placeholder="ת.ז." type="text">
                        </div>
                    </div>
                    <div class="field-container">
                        <input id="cardnumber" type="text" name="cardnumber" pattern="[0-9]*" placeholder="מספר כרטיס" inputmode="numeric">
                    ...
                    <div class="field-container">
                        <input id="expirationdate" name="expirationdate" placeholder="תוקף (mm/yy)" type="text" pattern="[0-9]*"
                               inputmode="numeric">
                    </div>
                    <div class="field-container">
                        <input id="securitycode" name="securitycode" type="text" placeholder="CVV" pattern="[0-9]*"
                               inputmode="numeric">
                    </div>
                </div>
            </div>
