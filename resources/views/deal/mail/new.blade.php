                                    ...
                                    <table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:35px 40px 10px;font-family:'Raleway',sans-serif;"
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px; text-align: right" align="right">
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 40px 25px;font-family:'Raleway',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; color: #fff; direction: rtl; line-height: 170%; text-align: right"><span
                                                            style="font-size: 18px; line-height: 30.6px;">
                                                            נכנסה הזמנה חדשה למערכת
                                                        </span>
                                                    </p>
                                                    <p style="font-size: 14px; direction: rtl; color: #fff; line-height: 170%; text-align: right">
                                                        <span>לקוח: </span>
                                                        <span>{{ $client }}</span>
                                                    </p>
                                                    <p style="font-size: 14px; direction: rtl; line-height: 170%; text-align: right">
                                                        <span>סכום: </span>
                                                        <span>{{ $total }} ש״ח</span>
                                                    </p>
                                                </div>
